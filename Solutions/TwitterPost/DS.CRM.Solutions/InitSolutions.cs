...
namespace DS.CRM
{
    ...
    public class InitSolutions
    {
        ...
        private readonly string _customEntityName = CRMTwitterPost._customEntityName;
        private readonly string _customPublisherEntityName = CRMTwitterPost._custom_PublisherEntityName;
        private readonly string _customConfigurationEntityName = CRMTwitterPost._customConfigurationEntityName;
            ...
            try
            {
                ...
                using (_serviceProxy = new OrganizationServiceProxy(serverConfig.OrganizationUri, serverConfig.HomeRealmUri, serverConfig.Credentials, serverConfig.DeviceCredentials))
                {
                   ...
                   // AutoNumberGeneration.AutoNumber.CreateWorkFlow(_serviceProxy, _languageCode);
                    CRMTwitter.CRMTwitterPost.SetProxy(_serviceProxy, _languageCode);
        ...
        public void CreateRequiredRecords()
        {
            ...
            //delete _customEntityName entity
            ...
            CRMTwitterPost.DotsTwitterMessage();
            // CreateTab();


            //delete dots_configuration entity
            if (IsEntityExist(_customPublisherEntityName) > 0)
            {
                DeleteEntityRequest customEntityNameFormField = new DeleteEntityRequest()
                {
                    LogicalName = _customPublisherEntityName,
                };
                _serviceProxy.Execute(customEntityNameFormField);
            }


            //for create dots_publisher entity           
            CRMTwitterPost.DotsTwitterPublisher();
            ...
            CRMTwitterPost.DotsTwitterConfiguration();

            //for create relationship
            CRMTwitterPost.CreateRelationShip();

            //############ assign dots_twitterpost form entity to solution #########################
            ...
            //############ End assign entity dots_twitterpost to solution #########################


            //############ assign dots_twitterpublisher form entity to solution #########################
            RetrieveEntityRequest retrievePublishertEntityRequest = new RetrieveEntityRequest
            {
                EntityFilters = EntityFilters.Entity,
                LogicalName = _customPublisherEntityName
            };

            RetrieveEntityResponse retrievetwitterpostEntityResponse = (RetrieveEntityResponse)_serviceProxy.Execute(retrievePublishertEntityRequest);

            AddSolutionComponentRequest addPublisherReq = new AddSolutionComponentRequest()
            {
                ComponentType = 1,
                ComponentId = (Guid)retrievetwitterpostEntityResponse.EntityMetadata.MetadataId,
                SolutionUniqueName = solution.UniqueName,
                AddRequiredComponents = true
            };
            _serviceProxy.Execute(addPublisherReq);

            //############ End assign entity dots_twitterpublisher to solution #########################

            //############ assign dots_twitterconfiguration form entity to solution #########################
            ...
            DeleteEntityRequest delTwitterEntPublisherReq = new DeleteEntityRequest { LogicalName = (_customPublisherEntityName) };
            _serviceProxy.Execute(delTwitterEntPublisherReq);
 ...
 .Remove();
            ...
            //   new XElement("SubArea", new XAttribute("Id", "SubArea_dots_twitterpublisher"),
            //   new XAttribute("Entity", _customPublisherEntityName)
            //   )));
            //root.Add(new XElement("Group",
            //    new XAttribute("Id", "Group_SubDotsquaresSocialPostWebForm"),
            //    new XAttribute("Title", "DotsquaresSocialPost"),
            //    new XElement("SubArea", new XAttribute("Id", "SubArea_dots_twitterpost"),
            //    new XAttribute("Entity", _customEntityName)
            //    )));

            // show two entities in vertical way
            XElement root = new XElement("Area");
            root.Add(new XAttribute("Id", "DotsquaresPack"),
                new XAttribute("ShowGroups", "true"),
                new XAttribute("Title", "DotsquaresPack"));

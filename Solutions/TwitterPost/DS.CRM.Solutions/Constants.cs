...
namespace DS.CRM
{
    ...
    {
        public const string CustomizationPrefix = "ta";
        public const string ManagedSolutionLocation = @"D:\temp\ManagedSolutionSocialMediaTwitter.zip";
        ...
        public static Guid[] WebResourceIds = new Guid[14];
        ...
        public const string SolutionUniqueName = "DsSocialMedia_Twitter";
        public const string SolutionFriendlyName = "Dotsquares Social Media  Solution";

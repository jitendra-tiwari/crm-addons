...
namespace DS.CRM
{
    ...
    public class InitSolutions
    {
        ...
        private readonly string _customEntityName = CRMEvent._customEntityName;
        private readonly string _customConfigurationEntityName = CRMEvent._customConfigurationEntityName;

...
namespace DS.CRM
{
    ...
    {
        public const string CustomizationPrefix = "ec";
        public const string ManagedSolutionLocation = @"D:\temp\ManagedSolutionForEventsCalendar.zip";
        ...
        public static Guid[] WebResourceIds = new Guid[15];
        ...
        public const string SolutionUniqueName = "DsEventCalendar";
        public const string SolutionFriendlyName = "Dotsquares EventsCalander Solution";

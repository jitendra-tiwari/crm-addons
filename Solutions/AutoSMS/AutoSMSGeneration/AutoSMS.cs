...
namespace AutoSMSGeneration
{
    public static class AutoSMS 
    {
        public  static  OrganizationServiceProxy _serviceProxy;
        public static string _customEntityName = "dots_autosms";
        public static string _customConfigurationEntityName = "dots_autosmsconfiguration";
        ...
        public static void DotsAutoNumberEntity()
        {
            ...
            CreateEntityRequest createRequest = new CreateEntityRequest
            {
                ...
                Entity = new EntityMetadata
                {
                    ...
                    DisplayName = new Label("DS AutoSMS", 1033),
                    DisplayCollectionName = new Label("Auto SMS", 1033),
                    Description = new Label("An entity to store information about autosms for particular entity.", 1033),
            ...
            CreateAttributeRequest createTargetEntityNameAttributeRequest = new CreateAttributeRequest
            {
                ...
                Attribute = new StringAttributeMetadata
                {
                    SchemaName = "dots_targetentityname",
                    RequiredLevel = new AttributeRequiredLevelManagedProperty(AttributeRequiredLevel.ApplicationRequired),
                    MaxLength = 100,
                    FormatName = StringFormatName.Text,
            ...
            CreateAttributeRequest createTargetEntityLogicalNameAttributeRequest = new CreateAttributeRequest
            {
                ...
                Attribute = new StringAttributeMetadata
                {
                    SchemaName = "dots_targetentitylogicalname",
                    RequiredLevel = new AttributeRequiredLevelManagedProperty(AttributeRequiredLevel.None),
                    MaxLength = 100,
                    FormatName = StringFormatName.Text,
            ...
            CreateAttributeRequest createTagetAttributeNameRequest = new CreateAttributeRequest
            {
                ...
                Attribute = new StringAttributeMetadata
                {
                    SchemaName = "dots_targetattributename",
                    RequiredLevel = new AttributeRequiredLevelManagedProperty(AttributeRequiredLevel.None),
                    MaxLength = 100,
                    FormatName = StringFormatName.Text,
            ...
            CreateAttributeRequest createTagetAttributeLogicalNameRequest = new CreateAttributeRequest
            {
                ...
                Attribute = new StringAttributeMetadata
                {
                    SchemaName = "dots_targetattributelogicalname",
                    RequiredLevel = new AttributeRequiredLevelManagedProperty(AttributeRequiredLevel.None),
                    MaxLength = 100,
                    FormatName = StringFormatName.Text,
            ...
            CreateAttributeRequest createInitializeNumberRequest = new CreateAttributeRequest
            {
                ...
                {
                    SchemaName = "dots_initializenumber",
                    RequiredLevel = new AttributeRequiredLevelManagedProperty(AttributeRequiredLevel.None),
                   // MaxLength = 100,
